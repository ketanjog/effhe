...
import json
import torch
from effhe.models.baseline_relu_1c1f import SimpleConvNet
from effhe.constants.paths import BASELINE_PATH
from effhe.models.baseline_relu_1c1f_enc import EncSimpleConvNet
...
while True:
    ...
    py_model = None
    if(model == "MNIST"):
        py_model = SimpleConvNet()
        py_model.load_state_dict(torch.load(BASELINE_PATH))

    enc_model = EncSimpleConvNet(py_model, use_socket=True, pub_key = public_key)
